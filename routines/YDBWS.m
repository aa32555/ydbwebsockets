YDBWS ;YottaDB Web Server; 05-07-2021
	;#################################################################
	;#                                                               #
...
Start(PORT) ;
	...
	S JOB=$ZJOB
	I '$$DirectoryExists^YDBWSUTILS("/tmp") D
	. W !,"Creating /tmp ..."
	. W:$$CreateDirectoryTree^YDBWSUTILS("/tmp") " succeeded" 
	ZSY "echo ""PID:"_JOB_",Port:"_PORT_""" > /tmp/YDBWS.info"
	W !,"YDBWebSockets Web Server started successfully. Port: ",PORT," - PID: ",JOB,!
	Q
Stop;
	K
	W ! N SRC,LINE
	S SRC="/tmp/YDBWS.info"
	O SRC:(readonly)
	U SRC R LINE C SRC S LINE=$TR(LINE,$C(13))
	N PORT,PID
	S PID=$P($P(LINE,","),":",2)
	S PORT=$P($P(LINE,",",2),":",2)
	I 'PID W !!,"YDBWebSockets Web Server could not be stopped!" Q
	ZSY "kill "_PID
	W !,"Killed PID: "_PID_". YDBWebSockets Web Server stopped successfully.",!
...
RUN(HTTPREQ,HTTPRSP,HTTPARGS)
	...
	S PID=$P($P(LINE,","),":",2)
	S PORT=$P($P(LINE,",",2),":",2)
	S @HTTPRSP@(1)="YDBWebSockets web server running on PID: "_PID_" and "_"Port: "_PORT
	Q       
	;
VIDS(HTTPREQ,HTTPRSP,HTTPARGS)
	...
	Q
JOB(TCPPORT)
	S @("$ZINTERRUPT=""I $$JOBEXAM^YDBWSZU($ZPOSITION)""")
...
WAIT
	...
	S $ETRAP="G ETCODE^YDBWS"
	S HTTPERR=0
	D RESPOND
	S $ETRAP="G ETSOCK^YDBWS"
...
MATCHF(ROUTINE,ARGS,AUTHNODE)
	...
	I PATTERN["?" S PATTERN=$P(PATTERN,"?")
	I PATTERN="" S PATTERN="/"
	I PATTERN=""  S PATTERN="YDBWebSockets"
	I PATTERN="/" S PATTERN="YDBWebSockets"
	I '$D(YDBWS(":WS","ROUTES")) D ROUTES
	I $D(YDBWS(":WS","ROUTES",HTTPREQ("method"),PATTERN)) D
	. S ROUTINE=$O(YDBWS(":WS","ROUTES",HTTPREQ("method"),PATTERN,""))
	Q
SENDATA
	N %WBUFF S %WBUFF=""
...
GetMimeType(EXT)
	I $G(EXT)="" S EXT="*"
	S EXT=$$LOW^YDBWSUTILS(EXT)
	I '$D(YDBWS(":WS","MIME")) D
	. S YDBWS(":WS","MIME","html")="text/html" 
	. S YDBWS(":WS","MIME","htm")="text/html" 
	. S YDBWS(":WS","MIME","shtml")="text/html"
	. S YDBWS(":WS","MIME","css")="text/css"
	. S YDBWS(":WS","MIME","xml")="text/xml"
	. S YDBWS(":WS","MIME","gif")="image/gif"
	. S YDBWS(":WS","MIME","jpeg")="image/jpeg" 
	. S YDBWS(":WS","MIME","jpg")="image/jpeg"
	. S YDBWS(":WS","MIME","js")="application/javascript"
	. S YDBWS(":WS","MIME","atom")="application/atom+xml"
	. S YDBWS(":WS","MIME","rss")="application/rss+xml"
	. S YDBWS(":WS","MIME","mml")="text/mathml"
	. S YDBWS(":WS","MIME","txt")="text/plain"
	. S YDBWS(":WS","MIME","jad")="text/vnd.sun.j2me.app-descriptor"
	. S YDBWS(":WS","MIME","wml")="text/vnd.wap.wml"
	. S YDBWS(":WS","MIME","htc")="text/x-component"
	. S YDBWS(":WS","MIME","png")="image/png"
	. S YDBWS(":WS","MIME","tif")="image/tiff" 
	. S YDBWS(":WS","MIME","tiff")="image/tiff"
	. S YDBWS(":WS","MIME","wbmp")="image/vnd.wap.wbmp"
	. S YDBWS(":WS","MIME","ico")="image/x-icon"
	. S YDBWS(":WS","MIME","jng")="image/x-jng"
	. S YDBWS(":WS","MIME","bmp")="image/x-ms-bmp"
	. S YDBWS(":WS","MIME","svg")="image/svg+xml"
	. S YDBWS(":WS","MIME","svgz")="image/svg+xml"
	. S YDBWS(":WS","MIME","webp")="image/webp"
	. S YDBWS(":WS","MIME","woff")="application/font-woff"
	. S YDBWS(":WS","MIME","jar")="application/java-archive" 
	. S YDBWS(":WS","MIME","war")="application/java-archive"
	. S YDBWS(":WS","MIME","ear")="application/java-archive"
	. S YDBWS(":WS","MIME","json")="application/json"
	. S YDBWS(":WS","MIME","hqx")="application/mac-binhex40"
	. S YDBWS(":WS","MIME","doc")="application/msword"
	. S YDBWS(":WS","MIME","pdf")="application/pdf"
	. S YDBWS(":WS","MIME","ps")="application/postscript" 
	. S YDBWS(":WS","MIME","eps")="application/postscript" 
	. S YDBWS(":WS","MIME","ai")="application/postscript"
	. S YDBWS(":WS","MIME","rtf")="application/rtf"
	. S YDBWS(":WS","MIME","m3u8")="application/vnd.apple.mpegurl"
	. S YDBWS(":WS","MIME","xls")="application/vnd.ms-excel"
	. S YDBWS(":WS","MIME","eot")="application/vnd.ms-fontobject"
	. S YDBWS(":WS","MIME","ppt")="application/vnd.ms-powerpoint"
	. S YDBWS(":WS","MIME","wmlc")="application/vnd.wap.wmlc"
	. S YDBWS(":WS","MIME","kml")="application/vnd.google-earth.kml+xml"
	. S YDBWS(":WS","MIME","kmz")="application/vnd.google-earth.kmz"
	. S YDBWS(":WS","MIME","7z")="application/x-7z-compressed"
	. S YDBWS(":WS","MIME","cco")="application/x-cocoa"
	. S YDBWS(":WS","MIME","jardiff")="application/x-java-archive-diff"
	. S YDBWS(":WS","MIME","jnlp")="application/x-java-jnlp-file"
	. S YDBWS(":WS","MIME","run")="application/x-makeself"
	. S YDBWS(":WS","MIME","pl")="application/x-perl"
	. S YDBWS(":WS","MIME","pm")="application/x-perl"
	. S YDBWS(":WS","MIME","prc")="application/x-pilot" 
	. S YDBWS(":WS","MIME","pdb")="application/x-pilot"
	. S YDBWS(":WS","MIME","rar")="application/x-rar-compressed"
	. S YDBWS(":WS","MIME","rpm")="application/x-redhat-package-manager"
	. S YDBWS(":WS","MIME","sea")="application/x-sea"
	. S YDBWS(":WS","MIME","swf")="application/x-shockwave-flash"
	. S YDBWS(":WS","MIME","sit")="application/x-stuffit"
	. S YDBWS(":WS","MIME","tcl")="application/x-tcl"
	. S YDBWS(":WS","MIME","tk")="application/x-tcl"
	. S YDBWS(":WS","MIME","der")="application/x-x509-ca-cert"
	. S YDBWS(":WS","MIME","pem")="application/x-x509-ca-cert"
	. S YDBWS(":WS","MIME","crt")="application/x-x509-ca-cert"
	. S YDBWS(":WS","MIME","xpi")="application/x-xpinstall"
	. S YDBWS(":WS","MIME","xhtml")="application/xhtml+xml"
	. S YDBWS(":WS","MIME","xspf")="application/xspf+xml"
	. S YDBWS(":WS","MIME","zip")="application/zip"
	. S YDBWS(":WS","MIME","bin")="application/octet-stream" 
	. S YDBWS(":WS","MIME","exe")="application/octet-stream" 
	. S YDBWS(":WS","MIME","dll")="application/octet-stream"
	. S YDBWS(":WS","MIME","deb")="application/octet-stream"
	. S YDBWS(":WS","MIME","dmg")="application/octet-stream"
	. S YDBWS(":WS","MIME","iso")="application/octet-stream"
	. S YDBWS(":WS","MIME","img")="application/octet-stream"
	. S YDBWS(":WS","MIME","msi")="application/octet-stream"
	. S YDBWS(":WS","MIME","msp")="application/octet-stream"
	. S YDBWS(":WS","MIME","msm")="application/octet-stream"
	. S YDBWS(":WS","MIME","docx")="application/vnd.openxmlformats-officedocument.wordprocessingml.document"
	. S YDBWS(":WS","MIME","xlsx")="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
	. S YDBWS(":WS","MIME","pptx")="application/vnd.openxmlformats-officedocument.presentationml.presentation"
	. S YDBWS(":WS","MIME","mid")="audio/midi"
	. S YDBWS(":WS","MIME","midi")="audio/midi"
	. S YDBWS(":WS","MIME","kar")="audio/midi"
	. S YDBWS(":WS","MIME","mp3")="audio/mpeg"
	. S YDBWS(":WS","MIME","ogg")="audio/ogg"
	. S YDBWS(":WS","MIME","m4a")="audio/x-m4a"
	. S YDBWS(":WS","MIME","ra")="audio/x-realaudio"
	. S YDBWS(":WS","MIME","3gpp")="video/3gpp"
	. S YDBWS(":WS","MIME","3gp")="video/3gpp"
	. S YDBWS(":WS","MIME","ts")="video/mp2t"
	. S YDBWS(":WS","MIME","mp4")="video/mp4"
	. S YDBWS(":WS","MIME","mpeg")="video/mpeg"
	. S YDBWS(":WS","MIME","mpg")="video/mpeg"
	. S YDBWS(":WS","MIME","mov")="video/quicktime"
	. S YDBWS(":WS","MIME","webm")="video/webm"
	. S YDBWS(":WS","MIME","flv")="video/x-flv"
	. S YDBWS(":WS","MIME","m4v")="video/x-m4v"
	. S YDBWS(":WS","MIME","mng")="video/x-mng"
	. S YDBWS(":WS","MIME","asx")="video/x-ms-asf"
	. S YDBWS(":WS","MIME","asf")="video/x-ms-asf"
	. S YDBWS(":WS","MIME","wmv")="video/x-ms-wmv"
	. S YDBWS(":WS","MIME","avi")="video/x-msvideo"
